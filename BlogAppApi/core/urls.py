...
urlpatterns = [
    ...
    path('api-auth/',include('rest_framework.urls')),    #browable api sayfası için 
    #path('api/rest-auth/', include('dj_rest_auth.urls')),       #django rest auh ile gelen endpointlerimiz için
